...
@Component({
  selector: 'app-massive-for-result',
  templateUrl: './massive-for-result.component.html',
  styleUrl: './massive-for-result.component.css'
})
export class MassiveForResultComponent {
  isNightMode = false;
